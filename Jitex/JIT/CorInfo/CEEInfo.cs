...
namespace Jitex.JIT.CorInfo
{
    internal static class CEEInfo
    {
        ...
        static CEEInfo()
        {
            ...
            IntPtr getMethodDefFromMethodIndex = CEEInfoVTable + IntPtr.Size * framework.GetMethodDefFromMethodOffset;

            ResolveTokenIndex = CEEInfoVTable + IntPtr.Size * framework.ResolveTokenOffset;
            ConstructStringLiteralIndex = CEEInfoVTable + IntPtr.Size * framework.ConstructStringLiteralOffset;
            ...
            MethodInfo resolveTokenMethod = typeof(CEEInfo).GetMethod(nameof(ResolveToken));
        ...
        public static void ResolveToken(IntPtr thisHandle, ref CORINFO_RESOLVED_TOKEN pResolvedToken)
        {
