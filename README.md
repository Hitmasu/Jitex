...
It's a library build in .NET Standard 2.0, work on all version >=.NET Core 2.0 after. 

|             | .NET Core (2.0 ~ 3.1) | .NET Framework (4.6.1 ~ 4.8)  | .NET 5                        | Mono              |
| ----------- | --------------------- | ----------------------------- | ----------------------------- | ----------------- |
| **Windows** | :heavy_check_mark:    | :green_circle: In development | :green_circle: In development | :x: Not supported |
| **Linux**   | :heavy_check_mark:    | :x: Not supported             | :green_circle: In development | :x: Not supported |
| **MacOS**   | :heavy_check_mark:    | :x: Not supported​             | :green_circle: In development | :x: Not supported |
